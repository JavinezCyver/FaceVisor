  ...
  Future<void> _sendImageToRoboflow() async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse(
            'https://serverless.roboflow.com/infer/workflows/code-qjcxw/detect-count-and-visualize'),
        headers: {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          _result =
              const JsonEncoder.withIndent('  ').convert(data); // Pretty JSON
        });
      } else {
        setState(() {
          ...
          child: Column(
            children: [
                ...
                child: Column(
                  children: [
                      ...
                      child: Container(
                        ...
                        child: const Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 10),
                            Text('Insert Image from Gallery',
                    ...
                    _image != null
                        ...
                        : const Text('(No image file selected)',
              ...
              if (_objectCount != null)
                Text('Detected Objects: $_objectCount',
